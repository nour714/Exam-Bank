...
export class AuthLayout extends BaseComponent {
  ...
  render() {
    ...
    this.element.style.cssText = 'background: #0b1120;';

    this.element.innerHTML = `
      <div class="fixed inset-0 z-0 overflow-hidden pointer-events-none">
          <div class="absolute rounded-full blur-3xl" style="width: 800px; height: 800px; background: rgba(99, 102, 241, 0.08); top: -160px; right: -160px; animation: bgOrbFloat1 15s infinite alternate ease-in-out;"></div>
          <div class="absolute rounded-full blur-3xl" style="width: 600px; height: 600px; background: rgba(108, 92, 231, 0.08); bottom: 0; left: -80px; animation: bgOrbFloat2 12s infinite alternate-reverse ease-in-out;"></div>
